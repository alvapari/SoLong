...
/*   Updated: 2024/10/06 22:35:25 by alvapari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_create_images(t_data *data)
{
	...
	if (!data->images.wall)
		exit(1);
	data->textures.enemie = mlx_load_png("./textures/enemie.png");
	if (!data->textures.enemie)
		exit(1);
	data->images.enemie = mlx_texture_to_image(data->mlx,
			data->textures.enemie);
	if (!data->images.enemie)
		exit(1);
...
{
	data->textures.exit = mlx_load_png("./textures/common.png");
