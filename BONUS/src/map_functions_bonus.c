...
/*   Updated: 2024/10/06 22:07:40 by alvapari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->player_position_x = (count - (count / (data->map.width + 1)))
		% data->map.width;
	data->player_position_y = (count - (count / (data->map.width + 1)))
		/ data->map.width;
}
